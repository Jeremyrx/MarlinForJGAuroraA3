...
#define STRING_CONFIG_H_AUTHOR "(Jeremy, IncZProbe)" // Who made the changes.
 ...
 *
 */
// JDR - need to explicitly define the Z_MIN_PROBE_PIN because the default is 32 for the RAMPS board
 ...
 */
 // JDR - note that the below define needed an edit in pins_RAMPS.h to avoid it being overwritten
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // JDR carry over vals from 3pt from below
  ...
  // JDR adjusted to fit bed and to probe nearest first 
